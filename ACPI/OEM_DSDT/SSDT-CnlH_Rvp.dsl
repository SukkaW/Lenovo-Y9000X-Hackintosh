 ...
 *
 * Disassembly of SSDT-CnlH_Rvp.bin, Mon Apr 12 05:08:55 2021
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000029EB (10731)
 *     Revision         0x02
 *     Checksum         0x2A
 *     OEM ID           "AcpiRe"
 *     OEM Table ID     "CnlH_Rvp"
 *     OEM Revision     0x00001000 (4096)
 *     Compiler ID      "INTL"
 *     Compiler Version 0x20160422 (538313762)
 */
DefinitionBlock ("", "SSDT", 2, "AcpiRe", "CnlH_Rvp", 0x00001000)
{
    ...
    Scope (\_SB.PCI0.SAT0)
    {
        ...
        Scope (PRT1)
        {
            ...
            {
                \_SB.PCI0.SAT0.PRT1.STPR._OFF ()
            }

            Method (ZPON, 0, NotSerialized)
            {
                \_SB.PCI0.SAT0.PRT1.STPR._ON ()
            }
            ...
            If (((RCG0 & One) && One))
            {
                ...
                Scope (\_GPE)
                {
                    Method (_E02, 0, NotSerialized)  // _Exx: Edge-Triggered GPE, xx=0x00-0xFF
                    {
                        ...
                        {
                            ADBG ("ODD detected")
                            \PIN.ON (\_SB.PCI0.SAT0.PRT1.PWRG)
                        }
            ...
            Switch (ToInteger (Arg1))
            {
                ...
                Case (0x03)
                {
                    ...
                    Switch (ToInteger (DRV))
                    {
                        Case (0x0001FFFF)
                        {
                            Return (\_SB.PCI0.SAT0.PRT1.STPR._STA ())
                        }
                        Default
                        {
                            Return (Ones)
