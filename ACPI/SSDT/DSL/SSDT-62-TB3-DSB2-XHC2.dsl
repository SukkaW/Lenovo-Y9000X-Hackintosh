DefinitionBlock ("", "SSDT", 2, "SUKA", "TB3XHC2", 0x00003000)
{
    /* Support methods */
    ...
    External (_SB.PCI0.RP17.PXSX.DSB0.NHI0, DeviceObj)
    ...
    External (_SB.PCI0.RP17.PXSX.MDUV, IntObj)
    External (_SB.PCI0.RP17.UPN1, IntObj)
    External (_SB.PCI0.RP17.UPN2, IntObj)

    External (_SB.PCI0.RP17.PXSX.DSB2, DeviceObj)
    External (_SB.PCI0.RP17.PXSX.DSB2.PRSR, FieldUnitObj)
    External (_SB.PCI0.RP17.PXSX.DSB2.LACR, FieldUnitObj)
    External (_SB.PCI0.RP17.PXSX.DSB2.LTRN, FieldUnitObj)
    External (_SB.PCI0.RP17.PXSX.DSB2.LACT, FieldUnitObj)
    External (_SB.PCI0.RP17.PXSX.DSB2.IIP3, FieldUnitObj)
            ...
            Device (XHC2)
            {
                ...
                Method (_PS0, 0, Serialized)  // _PS0: Power State 0
                {
                    ...
                    If (OSDW ())
                    {
                        ...
                        If (CondRefOf (\_SB.PCI0.RP17.TBST))
                        {
                            \_SB.PCI0.RP17.TBST ()
                        }
                    }
                ...
                Method (_DSM, 4, NotSerialized)  // _DSM: Device-Specific Method
                {
                    ...
                    If (CondRefOf (\_SB.PCI0.RP17.PXSX.DSB0.NHI0) && \USME == One)
                    {
                ...
                */
                ...
                Device (RHUB)
                {
                    ...
                    Device (SS01)
                    {
                        ...
                        Method (_DSM, 4, NotSerialized)  // _DSM: Device-Specific Method
                        {
                            If (CondRefOf (\_SB.PCI0.RP17.PXSX.DSB0.NHI0) && CondRefOf (\_SB.PCI0.RP17.UPN1) && \USME == One)
                            {
                                Local0 = Package ()
                                    {
                                        "UsbCPortNumber", 
                    ...
                    Device (SS02)
                    {
                        ...
                        Method (_DSM, 4, NotSerialized)  // _DSM: Device-Specific Method
                        {
                            If (CondRefOf (\_SB.PCI0.RP17.PXSX.DSB0.NHI0) && CondRefOf (\_SB.PCI0.RP17.UPN2) && \USME == One)
                            {
                                Local0 = Package ()
                                    {
                                        "UsbCPortNumber", 
